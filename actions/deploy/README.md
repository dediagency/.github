    ...
    steps:
      - name: Deploy using organizational action
        ...
        with:
          ...
          # ✅ db_operations: Création DB + Schema + Fixtures
          # ✅ cache_commands: Clear + Warmup cache
          # ✅ asset_commands: Installation assets
```
...
⚠️ = Paramètres obligatoires (seulement 2 !)

### Configuration plateforme (optionnel)

| Paramètre | Description | Défaut |
|-----------|-------------|--------|
| `platform` | Type de plateforme | `sylius` |
